...
class FilterUnit {
 public:
  ...
  Expression *left_expr() { return left_expr_; }

  Expression *right_expr() { return right_expr_; }

  const Expression *left_expr() const { return left_expr_; }

  const Expression *right_expr() const { return right_expr_; }
...
class FilterStmt {
 ...
 public:
  ...
  void set_conjunction_type(ConjunctionType type) { conjunction_type_ = type; }
